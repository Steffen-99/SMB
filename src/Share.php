...
class Share extends AbstractShare {
	...
	protected function connect() {
		...
		$this->connection->writeAuthentication($this->server->getUser(), $this->server->getPassword(), $this->server->getWorkgroup());
	...
	public function read($source) {
		...
		$connection->writeAuthentication($this->server->getUser(), $this->server->getPassword(), $this->server->getWorkgroup());
